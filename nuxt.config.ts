...
const personalSummary = 'A Product Designer who uses technical skills and product strategy to elevate design.';
...
module.exports = {
  ...
  */
  head: {
    title: `Dan Hiester • ${personalSummary}`,
    titleTemplate: `%s • Dan Hiester • ${personalSummary}`,
    meta: [
      { charset: 'utf-8' },
...
//      { name: 'theme-color', content: '#197FA1' },
      ...
      { hid: 'og:description', property: 'og:description', content: `Dan Hiester • ${personalSummary}` },
      ...
      { hid: 'twitter:image:alt', name: 'twiter:image:alt', content: `Dan Hiester • ${personalSummary}` },
